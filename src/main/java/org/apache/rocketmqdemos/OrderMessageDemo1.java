...
//分区顺序消息demo
public class OrderMessageDemo1 {
    public static String NAMESRV_ADDR = "127.0.0.1:9876";
    public static String TOPIC_2_QUEUE = "tiger_order_topic_2_queue";
    ...
    public static void partitionOrderMessageDemo() throws Exception {
        createOrderlyTopic(2, TOPIC_2_QUEUE);
    ...
    public static void startProducer() throws Exception {
        ...
        for (int i = 1; i <= 10; i++) {
            Message msg = new Message(TOPIC_2_QUEUE, ("Hello RocketMQ, " + i).getBytes(RemotingHelper.DEFAULT_CHARSET));
