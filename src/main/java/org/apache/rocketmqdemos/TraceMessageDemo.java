...
// 消息链路Demo
public class TraceMessageDemo {
    public static final String TOPIC_NAME = "tiger_topic_01";
    public static String NAMESRV_ADDRESSES = "127.0.0.1:9876";
    public static DefaultMQProducer producer = new DefaultMQProducer("tiger-producer", true, null);
    ...
    public static void startOneConsumer() throws MQClientException {
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("tiger_consumer_01", true);
